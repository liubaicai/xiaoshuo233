...
scheduler.every '1m' do
  ...
  begin
    ...
    unless File.exist?("#{File.dirname(__FILE__)}/../logs/scheduler.pid")

      pid_txt = File.open("#{File.dirname(__FILE__)}/../logs/scheduler.pid","wb")
      pid_txt.puts 'hello'
      pid_txt.close
      ...
      if File.exist?("#{File.dirname(__FILE__)}/../logs/scheduler.pid")
        File.delete("#{File.dirname(__FILE__)}/../logs/scheduler.pid")
      end
